...
?>
    <style>
        ...
        <div class="content content-boxed">
            ...
            <!-- Indicador Modo AFIP -->
            <?php $modo_afip = getAfipMode(); ?>
            <div class="block block-rounded" style="background-color: <?php echo ($modo_afip == 'produccion') ? '#5cb85c' : '#f0ad4e'; ?>; margin-bottom: 15px;">
                <div class="block-content" style="padding: 10px 15px;">
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            <i class="fa <?php echo ($modo_afip == 'produccion') ? 'fa-check-circle' : 'fa-flask'; ?>" style="color: white; font-size: 18px;"></i>
                            <span style="color: white; font-weight: bold; font-size: 14px; margin-left: 10px;">
                                <?php if ($modo_afip == 'produccion'): ?>
                                    MODO PRODUCCION - Las facturas se emiten contra AFIP real
                                <?php else: ?>
                                    MODO HOMOLOGACION (PRUEBAS) - Las facturas NO tienen validez fiscal
                                <?php endif; ?>
                            </span>
                        </div>
                    </div>
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content" style="text-align: center">
                    ...
                    $emitir = getAfipValue('emitir'); ?>
                        ...
                        <input type="hidden" id="emitir_factura_valor" value="<?php echo $emitir; ?>">

                        <?php if ($emitir == 1): ?>
                        <button class="btn btn-sm btn-minw btn-rounded btn-success" type="button" id="concretar_venta" style="margin-bottom: 20px;margin-top: 20px;width: 30%;">
                            <i class="fa fa-file-text-o push-5-r"></i>Concretar Venta y Facturar
                        </button>
                        <div id="espere_venta_activa" style="display:none;" ><i>(En proceso de emisión de factura electrónica, por favor aguarde unos segundos)</i></div>
                        <?php else: ?>
                        <button class="btn btn-sm btn-minw btn-rounded btn-warning" type="button" id="concretar_venta" style="margin-bottom: 20px;margin-top: 20px;width: 30%;">
                            <i class="fa fa-file-o push-5-r"></i>Concretar Venta (Presupuesto)
                        </button>
                        <div id="espere_venta_activa" style="display:none;" ><i>(Generando presupuesto, por favor aguarde unos segundos)</i></div>
                        <?php endif; ?>                    
                </div>
            </div>
