            ...
            <form class="form-horizontal" action="/usuarios_post.php" method="post" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        ...
                        <input type="text" class="form-control" name="nombre" id="nombre" value="" placeholder="Juan Pablo" />
                    </div>
                    <div class="col-xs-6">
                        <label>Apellido</label>
                        <input type="text" class="form-control" name="apellido" id="apellido" value="" placeholder="Marroni" />
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        ...
                        <input type="text" class="form-control" name="telefono" placeholder="+5492920535353" id="telefono" value="">
...
<script src="/assets/js/pages/usuarios.js?v=1.01"></script>
