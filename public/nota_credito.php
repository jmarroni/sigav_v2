                    ...
                    <div class="content">
                        <div class="block block-transparent block-themed text-center">
                            <div class="block-content">
                                <h1 class="h1 font-w700 text-white animated fadeInDown push-5">Reporte de Nota de Creditos</h1>
                    ...
                    <div class="col-sm-12">
                        <table id="tabla_compras">
                            ...
                            if (isset($_POST["reporte_desde"]) && isset($_POST["reporte_hasta"]) ){
                                $sql = "SELECT f.*,s.nombre as nombre_sucursal FROM nota_de_credito f inner join sucursales s ON s.id = f.sucursal_id WHERE `fecha` between '".$_POST["reporte_desde"]."' AND '".$_POST["reporte_hasta"]."' AND v.sucursal_id = ".getSucursal($_COOKIE["sucursal"])." $proveedor group BY pr.id ORDER BY cantidad DESC";
                            } else $sql = "SELECT f.*,s.nombre as nombre_sucursal FROM nota_de_credito f inner join sucursales s ON s.id = f.sucursal_id ORDER BY fecha DESC";
                            ...
                            if ($resultado->num_rows > 0) {
                                ...
                                while($row = $resultado->fetch_assoc()) {?>
                                    <tr style="<?php echo (($i % 2)== 0)?"background-color: #fff !important;":"background-color: #f9f9f9 !important;"; ?>">
                                        ...
                                        <td><a id="reenvio_pdf_<?php echo $row["numero"]; ?>" target="_blank" href="<?php echo $row["pdf"]; ?>">LINK</a></td>
                                        <td><a id="reenvio_mail_<?php echo $row["numero"]; ?>" href="#">REENVIAR MAIL</a></td>
                                    </tr>
                                <?php $i++;}
                            }
                            ?>
