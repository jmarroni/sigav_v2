            ...
            <div class="content">
                <div class="block block-transparent block-themed text-center">
                    <div class="block-content">
                        <h1 class="h1 font-w700 text-white animated fadeInDown push-5">Logs Transferencias</h1>
            ...
            <div class="row text-uppercase">
                <div class="col-sm-12">
                    <table id="tabla_compras">
                        ...
                        <tbody>
                            <?php 
                            $sql = "SELECT tl.*, so.nombre as origen, sd.nombre as destino from transferencias_logs tl left join transferencias t on t.id=tl.transferencia_id left join sucursales so ON tl.sucursal_origen_id = so.id left join sucursales sd ON tl.sucursal_destino_id = sd.id order by tl.updated_at DESC";
                            ...
                            if ($resultado->num_rows > 0) {
                                ...
                                while($row = $resultado->fetch_assoc()) {?>
                                    <tr style="<?php echo (($i % 2)== 0)?"background-color: #fff !important;":"background-color: #f9f9f9 !important;"; ?>">
                                        <td><?php echo $row["transferencia_id"]; ?></td>
