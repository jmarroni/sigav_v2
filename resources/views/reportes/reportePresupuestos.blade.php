            ...
            <div class="content">
                <div class="block block-transparent block-themed text-center">
                    <div class="block-content">
                        <h1 class="h1 font-w700 text-white animated fadeInDown push-5" style="color:white">Reporte de facturas</h1>
                                ...
                                @foreach($presupuestos as $presupuesto)
                                 <?php $i=0;?>
                                    <tr style="<?php echo (($i % 2)== 0)?"background-color: #fff !important;":"background-color: #f9f9f9 !important;"; ?>">
                                        <td><?php echo $presupuesto->numero; ?></td>
                                        <td>$&nbsp;<?php echo number_format($presupuesto->total,2,",","."); ?></td>
                                        <td><?php echo $presupuesto->fecha; ?></td>
                                        <td><?php echo $presupuesto->usuario; ?></td>
                                        <td><?php echo $presupuesto->nombre_sucursal; ?></td>
                                        <td><a id="reenvio_pdf_<?php echo $presupuesto->numero; ?>" target="_blank" href="<?php echo $presupuesto->pdf; ?>">LINK</a></td>
                                        <td><a id="reenvio_mail_<?php echo $presupuesto->numero; ?>" href="#">REENVIAR MAIL</a></td>
                                    </tr>
                                <?php $i++;?>
                            @endforeach
                            @endif
