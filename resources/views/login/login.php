...
<body>
	...
	<script>
		...
		$("#registro").click( function() {
			...
			$.ajax({
				url: 'http://www.sigav.com.ar/api/auth/signup',
				method: 'post',
		...
		$("#login").click( function() {
			...
			$.ajax({
				url: 'http://www.sigav.com.ar/api/auth/login',
				method: 'post',
		...
		$("#user").click( function() {
			...
			$.ajax({
				url: 'http://www.sigav.com.ar/api/auth/user',
				method: 'post',
				headers: {
		...
		$("#sucursales").click( function() {
			...
			$.ajax({
				url: 'http://www.sigav.com.ar/api/auth/sucursales',
				method: 'post',
				headers: {
			        "Accept": "application/json",
			        "Authorization": "Bearer " + token
		...
		$("#logout").click( function() {
			...
			$.ajax({
				url: 'http://www.sigav.com.ar/api/auth/logout',
				method: 'post',
				headers: {
			        "Accept": "application/json",
			        "Authorization": "Bearer " + token
		...
		$("#productos").click( function() {
			...
			$.ajax({
				url: 'http://www.sigav.com.ar/api/auth/productos',
				method: 'post',
				headers: {
			        "Accept": "application/json",
			        "Authorization": "Bearer " + token
		...
		$("#productos_sucursal").click( function() {
			...
			$.ajax({
				url: 'http://www.sigav.com.ar/api/auth/productosPorSucursal',
				method: 'post',
				headers: {
			        "Accept": "application/json",
			        "Authorization": "Bearer " + token
