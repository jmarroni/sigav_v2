...
class ProductoController extends Controller
{
    ...
    public function productos(Request $request)
    {
        ...
        $productos = DB::table('productos')->
            ...
            select('productos.id', 'productos.codigo_barras', 'productos.nombre', 'productos.descripcion', 'productos.precio_unidad', 'productos.costo', 'productos.stock', 'productos.stock_minimo', 'productos.usuario', 'productos.fecha', 'productos.precio_mayorista', 'productos.es_comodato', 'categorias.nombre AS categoria', 'proveedor.nombre AS nombre_proveedor', 'proveedor.apellido AS apellido_proveedor')
            ->get();
